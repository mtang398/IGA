...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 3), // double()(int, int, double, double *, int, CacheItem *, int *)
/*  1 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  2 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/*  3 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14), // double
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 3), // double *
/*  5 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/*  6 */ _CFFI_OP(_CFFI_OP_POINTER, 58), // CacheItem *
/*  7 */ _CFFI_OP(_CFFI_OP_POINTER, 1), // int *
/*  8 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION, 3), // double()(int, int, int, int, double, double, double *, int, double *, int, double *, int, CacheItem *, int *, CacheItem *, int *)
...
/* 27 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // void()(double, double, double *, int, int, double *, int, double *, int, double *, int, double *)
...
/* 41 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // void()(int, int, double *, double *, int)
...
/* 48 */ _CFFI_OP(_CFFI_OP_FUNCTION, 59), // void()(int, int, int, double *, double *, double * *, int, int)
...
/* 54 */ _CFFI_OP(_CFFI_OP_POINTER, 4), // double * *
/* 55 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/* 56 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/* 57 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 58 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // CacheItem
/* 59 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};

_CFFI_UNUSED_FN
static void _cffi_checkfld_typedef_CacheItem(CacheItem *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->i) | 0);  /* check that 'CacheItem.i' is an integer */
  (void)((p->k) | 0);  /* check that 'CacheItem.k' is an integer */
  { double *tmp = &p->t; (void)tmp; }
  { double *tmp = &p->value; (void)tmp; }
}
struct _cffi_align_typedef_CacheItem { char x; CacheItem y; };

static double _cffi_d_N(int x0, int x1, double x2, double * x3, int x4, CacheItem * x5, int * x6)
{
  return N(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_N(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  double x2;
  ...
  if (!PyArg_UnpackTuple(args, "N", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
  ...
  if (datasize != 0) {
    x5 = ((size_t)datasize) <= 640 ? (CacheItem *)alloca((size_t)datasize) : NULL;
...
#else
#  define _cffi_f_N _cffi_d_N
#endif

static double _cffi_d_R(int x0, int x1, int x2, int x3, double x4, double x5, double * x6, int x7, double * x8, int x9, double * x10, int x11, CacheItem * x12, int * x13, CacheItem * x14, int * x15)
{
  return R(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_R(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "R", 16, 16, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12, &arg13, &arg14, &arg15))
    return NULL;
  ...
  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(6), arg12, (char **)&x12);
  if (datasize != 0) {
    x12 = ((size_t)datasize) <= 640 ? (CacheItem *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(6), arg12, (char **)&x12,
            datasize, &large_args_free) < 0)
      return NULL;
  }

  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(7), arg13, (char **)&x13);
  if (datasize != 0) {
    x13 = ((size_t)datasize) <= 640 ? (int *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(7), arg13, (char **)&x13,
            datasize, &large_args_free) < 0)
      return NULL;
  }
  ...
  if (datasize != 0) {
    x14 = ((size_t)datasize) <= 640 ? (CacheItem *)alloca((size_t)datasize) : NULL;
  ...
  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(7), arg15, (char **)&x15);
  if (datasize != 0) {
    x15 = ((size_t)datasize) <= 640 ? (int *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(7), arg15, (char **)&x15,
            datasize, &large_args_free) < 0)
      return NULL;
  }
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = R(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_R _cffi_d_R
#endif

static void _cffi_d_bernstein_basis(int x0, int x1, double * x2, double * x3, int x4)
{
  bernstein_basis(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_bernstein_basis(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "bernstein_basis", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
...
#else
#  define _cffi_f_bernstein_basis _cffi_d_bernstein_basis
#endif

static void _cffi_d_surface_point(double x0, double x1, double * x2, int x3, int x4, double * x5, int x6, double * x7, int x8, double * x9, int x10, double * x11)
{
  surface_point(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_surface_point(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "surface_point", 12, 12, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11))
    return NULL;
...
#else
#  define _cffi_f_surface_point _cffi_d_surface_point
#endif

static void _cffi_d_tensor_bernstein_basis(int x0, int x1, int x2, double * x3, double * x4, double * * x5, int x6, int x7)
{
  tensor_bernstein_basis(x0, x1, x2, x3, x4, x5, x6, x7);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_tensor_bernstein_basis(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "tensor_bernstein_basis", 8, 8, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7))
    return NULL;
...
#else
#  define _cffi_f_tensor_bernstein_basis _cffi_d_tensor_bernstein_basis
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "N", (void *)_cffi_f_N, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_N },
  { "R", (void *)_cffi_f_R, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 9), (void *)_cffi_d_R },
  { "bernstein_basis", (void *)_cffi_f_bernstein_basis, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 41), (void *)_cffi_d_bernstein_basis },
  { "surface_point", (void *)_cffi_f_surface_point, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 27), (void *)_cffi_d_surface_point },
  { "tensor_bernstein_basis", (void *)_cffi_f_tensor_bernstein_basis, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 48), (void *)_cffi_d_tensor_bernstein_basis },
};

static const struct _cffi_field_s _cffi_fields[] = {
  { "i", offsetof(CacheItem, i),
         sizeof(((CacheItem *)0)->i),
         _CFFI_OP(_CFFI_OP_NOOP, 1) },
  { "k", offsetof(CacheItem, k),
         sizeof(((CacheItem *)0)->k),
         _CFFI_OP(_CFFI_OP_NOOP, 1) },
  { "t", offsetof(CacheItem, t),
         sizeof(((CacheItem *)0)->t),
         _CFFI_OP(_CFFI_OP_NOOP, 3) },
  { "value", offsetof(CacheItem, value),
             sizeof(((CacheItem *)0)->value),
             _CFFI_OP(_CFFI_OP_NOOP, 3) },
};

static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "$CacheItem", 58, _CFFI_F_CHECK_FIELDS,
    sizeof(CacheItem), offsetof(struct _cffi_align_typedef_CacheItem, y), 0, 4 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_nurbs_c(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_nurbs_c(void) { return NULL; }
#  else
     initnurbs_c(void) { }
#  endif
#  endif
...
PyInit_nurbs_c(void)
{
  return _cffi_init("nurbs_c", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initnurbs_c(void)
{
  _cffi_init("nurbs_c", 0x2601, &_cffi_type_context);
}
#endif
